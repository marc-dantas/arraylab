...
class Stack:
    ...
    def include(self, other: 'Stack') -> 'Stack':
        self.__list.extend(other)
        return self
    
    def push(self, value: object) -> 'Stack':
    ...
    def select_slice(self, start: int, end: int, /) -> 'Stack':
        return Stack(self.__list[start:end])
    ...
    def __str__(self) -> str:
        ...
        return f"arraylab.Stack[{comma_sep}]"
